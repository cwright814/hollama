...
[ ] Consider upgrading to the latest Node LTS if compatible with the upgraded packages (if it works, update .nvmrc and .node-version)
[ ] Update this files with a few tasks from the top of README.md
